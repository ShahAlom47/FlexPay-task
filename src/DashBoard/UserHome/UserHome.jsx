...
const UserHome = () => {
    ...
    return (
        <div className="">
           ...
           {user.role==='user'?<div className="flex gap-12 flex-wrap justify-center lg:justify-between md:justify-between mx-auto  min-h-screen p-3">
                            ...
                            <div> <NavLink to={'/userHome/sendMoney'}>
                                <button className="flex flex-col justify-center items-center gap-2 hoverBtn hover:border-2 border-black p-2 rounded-md  font-semibold">
