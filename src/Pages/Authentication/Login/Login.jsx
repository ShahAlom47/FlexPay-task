...
const Login = () => {
    ...
    return (
        <div className="bg-[#0e0d0e] ">
        <Helmet>
            <title>Login</title>
        </Helmet>
        <ToastContainer />
        <nav className="py-4 bg-white text-black">
            <h1 className=" text-center text-5xl"> FlexPay </h1>
        </nav>
        <div className="max-w flex lg:flex-row md:flex-row flex-col items-center justify-center lg:p-6 md:p-5 my-6 ">
            ...
            <div className="md:w-1/2 lg:w-1/2">
                <div className=" lg:w-11/12 m-auto bg-slate-800 rounded-md p-5 shadow-md shadow-black">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="mt-4 flex gap-3 flex-col items-center">
                      ...
                      <p className="text-red-500">{errMsg}</p>
                       ...
                       <LoadCanvasTemplate  />
                        ...
                        <input className="btn  w-full bg-[#271b8c] hover:bg-[#1d215a] rounded-sm text-white" type="submit" value={'Login'} />
                    </form>
