...
const AgentWithdrawRequest = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post(
                "https://mobile-banking-tawny.vercel.app/api/transaction/withdrawRequest",

                {
                    receiverNumber: adminNumber,
                    amount, pin
                },
    ...
    return (
        <div className="max-w-md mx-auto p-6 bg-white shadow-md rounded-md text-black">
            ...
            {step === 1 ? (
                <>
                    <h2 className="text-xl font-bold mb-4">Agent Withdraw Request</h2>
